...
static GHandle      ghButton1, ghButton2, ghButton3, ghButtonOpen;
...
static void _createWidgets(void) {
    ...
    wi.g.x = 10;
    wi.g.y = 10;
    wi.text = "Open Colorpicker";
    ghButtonOpen = gwinButtonCreate(0, &wi);
    ...
    while(1) {
        ...
        switch(pe->type) {
            ...
            case GEVENT_GWIN_BUTTON:
                ...
                } else if (((GEventGWinButton *)pe)->gwin == ghButtonOpen) {
                    gwinShow(ghFrame1);
                    _createWidgets();
                }
...
TEST_CASE("uGFX testcase 03", "[ugfx][gui][hmi][iot]")
{
