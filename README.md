...
Code provided in this repository gets the image from camera and prints it out as ASCII art to the serial port, and display on LCD 6fps.
...
| Interface | Camera Pin | Pin Mapping for ESP32 DevKitJ |
| :--- | :---: | :---: | :---: |
...
| Pixel Data Bit 0 | D0 | IO4 |
| Pixel Data Bit 1 | D1 | IO5 |
| Pixel Data Bit 2 | D2 | IO18 |
| Pixel Data Bit 3 | D3 | IO19 |
| Pixel Data Bit 4 | D4 | IO36 |
| Pixel Data Bit 5 | D5 | IO39 |
| Pixel Data Bit 6 | D6 | IO34 |
| Pixel Data Bit 7 | D7 | IO35 |
| Camera Reset | RESET | IO0 |
| Camera Power Down | PWDN | *see Note 2* |
| Power Supply 3.3V | 3V3 | 3V3 |
| Ground | GND | GND |

| LCD PIN | Pin Mapping for ESP32 DevKitJ |
| :--- | :---: |
| MISO | IO12 |
| MOSI | IO13 |
| CLK | IO14 |
...
5. whether use LCD display configed by `make menuconfig`.
...
* [ov7670.c](components/camera/ov7670.c), [ov7670.h](components/camera/ov7670.h), [ov7670_regs.h](components/camera/ov7670_regs.h) and [sensor.h](components/camera/sensor.h) - definition of registers of OV7670 to configure camera funcinality. Functions to set register groups to reset camera to default configuration and configure specific functionality like resolution or pixel format. Setting he registers is performed by lower level function in files below.
...
* OpenMV implementation for OV7670 by Ibrahim Abdelkader
